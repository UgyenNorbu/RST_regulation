...
## CD registration
a. A motor vehicle belonging to the following are entitled for CD registration:
...
a. A motor vehicle is exempt from paying initial registration or annual renewal fee if it:
...
1.18.2	Notwithstanding section 1.18, revival of registration of de-registered vehicle which is proposed to be driven on the road shall be permitted upon providing satisfactory justification and on payment of renewal fees up-to-date together with the penalty @Nu.10 per day for the duration it has not been renewed. Maximum penalty limit of Nu.3000 shall not apply in such cases.
